...
namespace GCR.Commons
{
    ...
    public class MemoryCacheHelper : ICache
    {
        ...
        public bool Set(string key, object value, TimeSpan expiresSliding, TimeSpan expiressAbsoulte)
        {
            ...
            if (expiresSliding == TimeSpan.Zero)
            {
                expiresSliding = TimeSpan.FromSeconds(30000);
            }
        ...
        public bool Set(string key, object value, TimeSpan expiresIn, bool isSliding = false)
        {
            ...
            {
                expiresIn = TimeSpan.FromSeconds(30000);
            }
            Cache.Set(key, value,
                isSliding
        ...
        /// <param name="value">缓存Value</param>
        /// <returns></returns>
        public void Set(string key, object value, bool isSliding = false)
        {
            Set(key, value, TimeSpan.FromDays(1), isSliding);
        }
